...
public class StateTest {
    ...
    public static class MyFlatMap extends RichFlatMapFunction<Event, String>{
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            myAggregatingState = getRuntimeContext().getAggregatingState(new AggregatingStateDescriptor<Event, Long, String>("my-aggregate", new AggregateFunction<Event, Long, String>() {
                @Override
...
//            System.out.println( "my value" + myValueState.value());
            ...
            System.out.println("my map value : " + event.user + "  " + myMapState.get(event.user));

            myAggregatingState.add(event);
            System.out.println("my aggregate state: " + myAggregatingState.get());

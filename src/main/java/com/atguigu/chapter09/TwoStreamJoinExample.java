    ...
    public static void main(String[] args) throws Exception{
        ...
        stream1.keyBy(data -> data.f0)
                ...
                .process(new CoProcessFunction<Tuple3<String, String, Long>, Tuple3<String, String, Long>, Object>() {
                    ...
                    @Override
                    public void processElement1(Tuple3<String, String, Long> stringStringLongTuple3, CoProcessFunction<Tuple3<String, String, Long>, Tuple3<String, String, Long>, Object>.Context context, Collector<Object> collector) throws Exception {
                        // 获取另一条流中的所有数据，配对输出
                        for (Tuple2<String, Long> right : stream2ListState.get()) {
                            collector.collect(stringStringLongTuple3.f0 + " " + stringStringLongTuple3.f2 + "=>" + right);
                        }

                        stream1ListState.add(Tuple2.of(stringStringLongTuple3.f0, stringStringLongTuple3.f2));
                    }

                    @Override
                    public void processElement2(Tuple3<String, String, Long> stringStringLongTuple3, CoProcessFunction<Tuple3<String, String, Long>, Tuple3<String, String, Long>, Object>.Context context, Collector<Object> collector) throws Exception {
                        for (Tuple2<String, Long> left : stream1ListState.get()) {
                            collector.collect(left + "=>" + stringStringLongTuple3.f0 + " " +stringStringLongTuple3.f2);
                        }

                        stream2ListState.add(Tuple2.of(stringStringLongTuple3.f0, stringStringLongTuple3.f2));
                    }
                }).print();
